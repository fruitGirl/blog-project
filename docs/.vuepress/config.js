    ...
    themeConfig: {
            ...
            "/vue2/": [
                {
                    title: "vue2", // 必要的
                    sidebarDepth: 2, // 可选的, 默认值是 1
                    children: ["style中的scoped属性", "key的作用"],
                },
            ],
            "/vue3/": [
                {
                    title: "vue3", // 必要的
                    sidebarDepth: 2, // 可选的, 默认值是 1
                    children: ["如何使用webpack从零开始搭建一个vue项目？"],
                },
            ],
            "/chart/": [
                {
        ...
        blogConfig: {
            ...
            socialLinks: [
                ...
                {
                    icon: "reco-juejin",
                    link: "https://juejin.cn/user/325111173876509/posts",
                },
            ],
        },
        valineConfig: {
